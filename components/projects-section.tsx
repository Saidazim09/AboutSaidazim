      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex items-center gap-2 px-4 py-2 bg-secondary/30 border-b border-border/50">
            ...
            <span className="text-xs text-muted-foreground font-mono ml-2">saydis_market.loyihasi</span>
          ...
          <div className="grid lg:grid-cols-5 gap-0">
            ...
            <div className="lg:col-span-3 p-5">
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                >
                  <Image
                    ...
                    alt="Saydis Market Logo"
                    fill
                    className="object-contain"
                  />
                </motion.div>
                <div>
                  <h3 className="text-xl font-bold text-neon">Saydis Market</h3>
              ...
              {activeTab === "TECH" && (
                <div className="space-y-3">
                  <p className="text-sm text-muted-foreground">Saydis Market’da qo‘llanilgan texnologiyalar:</p>
              ...
              {activeTab === "LINKS" && (
                <div className="space-y-3">
                  <a href="https://t.me/saydis_market" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-secondary/30 rounded-lg hover:bg-secondary/50 transition-colors group">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">@saydis_market</p>
                    </div>
            ...
            <div className="lg:col-span-2 p-4 bg-secondary/20 border-l border-border/30">
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 bg-secondary/50 rounded-t-lg mb-3">
                ...
                <span className="text-[10px] text-muted-foreground font-mono">saydis.market</span>
              </div>

              {/* Mini header */}
              <div className="flex items-center justify-between mb-3 pb-2 border-b border-border/30">
                <span className="text-neon font-bold text-sm">Saydis Market</span>
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="relative w-14 h-14 rounded-xl overflow-hidden flex-shrink-0 bg-black p-1.5 border border-neon/30">
                  <Image
                    src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/photo_1_2026-03-14_18-15-56-Zw1OpxcHR9rCzd2ILa5NeFVwolMJYI.jpg"
                    alt="Saydis Invest Logo"
                    fill
                    className="object-contain"
                  />
                </div>
                <div className="flex-1">
                  <h3 className="text-lg font-bold text-neon">Saydis Invest</h3>
              ...
              <p className="text-sm leading-relaxed mb-3">
                <span className="text-neon">Aksiyalar</span>, <span className="text-neon">Crypto</span> uchun kelajak platformasi va Saydis Market bilan bevosita integratsiya. Foydalanuvchilar bizning <span className="text-neon">Ekotizimimizga</span> sarmoya kiritishlari mumkin.
              </p>
              <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                <span className="text-neon">Saydis Invest</span> kundalik xarid qilish va aqlli investitsiya o'rtasidagi bo'shliqni bartaraf etadi - barchasi Nolbir ekotizimida. O‘zbekistonning fintech maydoni uchun inqilobiy qadam.
              </p>

              {/* Tags */}
              <div className="flex flex-wrap gap-2">
                {["Aksiyalar", "Crypto", "DeFi", "Saydis Ekotizimi", "Mobile-First"].map((tag) => (
